          ...
          <form role="form" method="post" class="formularioVenta">
            <div class="box-body">
              <div class="box">
                ...
                <div class="form-group">             
                  <div class="input-group">               
                    <select class="form-control" id="seleccionarCliente" name="seleccionarCliente"  style="color: black !important;" required>
                    ...
                    foreach ($listaProducto as $key => $value) {
                      ...
                      echo '<div class="row" style="padding:5px 15px">
                            <div class="col-xs-6" style="padding-right:0px">
                              <div class="input-group">
                                <span class="input-group-addon"><button type="button" style="font-size: 2px;" class="btn btn-danger btn-xs quitarProducto"  idProducto="'.$value["id"].'"><i class="fa-solid fa-x"></i></button></span>
                ...
                <div class="form-group row">
                  <div class="col-10 mb-3" style="padding-right:0px">
                    <div class="input-group">
                  ...
                  <div class="col-12 cajasMetodoPago"></div>
